...
## Blockers
The component map remains blocked until `kernel-spec-freeze` and `vm-target-spec` are accepted; then publish the dependency order before component implementation begins.
