# Tasks: portable observation validation

- [x] Reproduce false agreement on the unchanged baseline gate.
- [x] Validate portable values, pure-world sentinels, and comparison fuel.
- [x] Reject ambiguous/non-finite adapter JSON and unsupported quotation results.
