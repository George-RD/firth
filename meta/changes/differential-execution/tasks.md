# Tasks: differential-execution

- [x] Implement deterministic typed source generation and bounded process execution.
- [x] Compare the real hosts with explicit failure and inconclusive classes.
